...
from domain.models import Config, CropProfile, SensorReading, CaptureSession, BiometricMetric, AgronomicConclusion
...
class ICaptureSessionRepository(Protocol):
    ...
    def get_all_by_plant(self, plant_id: int) -> List[CaptureSession]: ...
